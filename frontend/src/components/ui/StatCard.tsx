 ...
 * No box, no decorative icon tile — the number carries the weight and
 * a hairline top rule separates each metric in a row.
 */
  ...
  return (
    <div className="relative border-t border-white/[0.07] pt-4">
      <div className="flex items-center gap-2">
        {Icon && <Icon className="h-3.5 w-3.5 text-textdim" aria-hidden="true" />}
        <div className="text-2xs font-semibold uppercase tracking-[0.14em] text-textdim">{label}</div>
