    ...
    <div className="auth-shell relative flex min-h-screen items-center justify-center px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-[420px] animate-fadeUp">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-3 text-sm text-textdim">Analyst sign-in · fraud screening and explainability</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="auth-card space-y-5 p-7" noValidate data-testid="login-form">
          <div>
            ...
            <div className="relative">
              ...
              <input id="email" type="email" autoComplete="email" placeholder="analyst@example.com"
                className="input pl-10" {...register("email")} />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="password" type={showPassword ? "text" : "password"} autoComplete="current-password" placeholder="••••••••"
                className="input pl-10 pr-11" {...register("password")} />
              <button
                type="button"
          ...
          <p className="text-center text-sm text-textdim">
            No account?{" "}
            <Link to="/register" className="font-semibold text-accent transition-colors hover:underline">
              Create one
            </Link>
          </p>
          <div className="rounded-[10px] border border-border bg-surface px-4 py-3.5 text-[13px] leading-relaxed text-textdim">
            <div className="label-sm mb-2">Demo accounts (seeded)</div>
