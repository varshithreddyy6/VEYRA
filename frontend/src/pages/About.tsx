    ...
    <div className="space-y-14">
      ...
      <section className="max-w-3xl">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div className="leading-none">
            <div className="text-lg font-extrabold tracking-tight text-text">VEYRA</div>
            <div className="mt-1 text-xs font-medium text-muted">AI Fraud Intelligence</div>
          </div>
        </div>
        <p className="text-lg leading-relaxed text-text">
          <strong className="font-semibold text-text">VEYRA</strong> is the application brand for the{" "}
          <strong className="font-semibold text-text">CREDIT CARD FRAUD DETECTION SYSTEM</strong> — an end-to-end fraud
      ...
      <section className="max-w-3xl">
        ...
        <p className="text-[15px] leading-relaxed text-text">
          VEYRA turns a single fraud-screening question — <em className="text-text">“is this transaction suspicious, and
      ...
      <section className="max-w-3xl">
        ...
        <ol className="space-y-3 text-[15px] leading-relaxed text-text">
          <li><strong className="font-semibold text-text">Validate.</strong> The transaction payload is checked (amount, required anonymized features, reference), and the analyst is authenticated.</li>
          <li><strong className="font-semibold text-text">Prepare features.</strong> The shared preprocessing module — the exact pipeline used at training time — transforms the row.</li>
          <li><strong className="font-semibold text-text">Run the model.</strong> The active XGBoost model (CCDFS-XGB-…) predicts a fraud probability for the transaction.</li>
          <li><strong className="font-semibold text-text">Evaluate rules.</strong> Deterministic rules (e.g. amount anomalies, empty fields, unusual velocity) run alongside the model and contribute independent signals.</li>
          <li><strong className="font-semibold text-text">Explain.</strong> A TreeExplainer produces per-feature SHAP contributions, summarized into a human-readable statement.</li>
          <li><strong className="font-semibold text-text">Persist.</strong> The screening, its verdict and its explanation are stored and appear in Activity, Alerts and the audit trail.</li>
        </ol>
      </section>
      ...
      <section className="grid gap-14 lg:grid-cols-2">
        <div>
          ...
          <p className="text-sm leading-relaxed text-text">
            ...
            31 columns, no cardholder details). It is <strong className="font-semibold text-text">not committed</strong> to
      ...
      <section className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
        <div className="panel-flat p-7">
          ...
          <div className="mb-6 flex items-center gap-4">
            <span className="flex h-14 w-14 items-center justify-center rounded-2xl border border-border bg-surface text-lg font-bold text-text">
              V
            </span>
            <div>
              <div className="text-lg font-semibold text-text">VARSHITH REDDY</div>
          ...
          <ul className="space-y-3.5 text-sm">
            <li className="flex items-center gap-3 text-text">
              ...
              <a href="tel:+919393081415" className="transition-colors hover:text-text">+91 93930 81415</a>
            </li>
            <li className="flex items-center gap-3 text-text">
              <Mail className="h-4 w-4 shrink-0 text-accent" aria-hidden="true" />
              <a href="mailto:varshithreddyy6@gmail.com" className="break-all transition-colors hover:text-text">varshithreddyy6@gmail.com</a>
            </li>
            <li className="flex items-center gap-3 text-text">
              <Linkedin className="h-4 w-4 shrink-0 text-accent" aria-hidden="true" />
              <a href="https://linkedin.com/in/varshithreddyvangeti" target="_blank" rel="noreferrer" className="transition-colors hover:text-text">
        ...
        <div>
          ...
          <ul className="list-disc space-y-2.5 pl-5 text-sm leading-relaxed text-text">
            <li>LOW / MEDIUM / HIGH are <strong className="font-semibold text-text">model screening categories</strong>, not banking decisions.</li>
