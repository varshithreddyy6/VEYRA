  ...
  return (
    <div className="app-atmosphere relative flex min-h-screen items-center justify-center px-4 py-10">
      <div className="relative z-10 w-full max-w-[440px] animate-fadeUp">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="panel space-y-5 p-7" noValidate data-testid="register-form">
          <div>
            <label htmlFor="full_name" className="label">Full name</label>
            <input id="full_name" className="input h-11" placeholder="Jane Analyst" {...register("full_name")} />
            {errors.full_name && <p className="field-error" role="alert">{errors.full_name.message}</p>}
          </div>
          <div>
            <label htmlFor="email" className="label">Email</label>
            <input id="email" type="email" autoComplete="email" className="input h-11" placeholder="you@example.com" {...register("email")} />
