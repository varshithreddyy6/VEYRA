...
export default function Activity() {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-white/[0.06] pb-6">
      ...
      {selectedId && (
        <div className="fixed inset-0 z-40 flex justify-end" role="dialog" aria-modal="true" aria-label="Transaction detail">
          ...
          />
          <div className="relative z-10 h-full w-full max-w-xl overflow-y-auto border-l border-white/[0.08] bg-surface p-8 shadow-2xl animate-fadeUp"
          >
              ...
              <>
                <dl className="grid grid-cols-2 gap-x-6 gap-y-5 text-sm">
                  <div className="border-t border-white/[0.06] pt-3">
                    ...
                    <dd className="mt-1.5 break-all font-mono text-[13px] text-white">{detailQuery.data.external_ref}</dd>
                  </div>
                  <div className="border-t border-white/[0.06] pt-3">
                    <dt className="label-sm">Amount</dt>
                    <dd className="mt-1.5 font-mono tabular-nums text-white">{formatCurrency(detailQuery.data.amount)}</dd>
                  </div>
                  <div className="border-t border-white/[0.06] pt-3">
                    <dt className="label-sm">Occurred</dt>
                    <dd className="mt-1.5 text-[13px] text-white">{formatDateTime(detailQuery.data.occurred_at)}</dd>
                  </div>
                  <div className="border-t border-white/[0.06] pt-3">
                ...
                <div className="mt-4 space-y-3">
                  {detailQuery.data.screenings.slice(0, 3).map((s) => (
                    <div key={s.id} className="rounded-[10px] border border-white/[0.06] bg-white/[0.02] p-4">
