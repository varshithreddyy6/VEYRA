...
export default function Explainability() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid gap-14 lg:grid-cols-2">
        ...
        <section data-testid="local-explanation">
          <div className="section-head">
            ...
            {txId.trim() && (
              <nav aria-label="Breadcrumb" className="text-2xs text-textdim">
                <Link to="/explainability" className="transition-colors hover:text-white" onClick={() => setParams({})}>
                  Explainability
                </Link>
          ...
          {local.data?.available && (
            <>
              {/* Focal numbers */}
              <div className="grid gap-x-8 gap-y-6 border-y border-white/[0.06] py-6 sm:grid-cols-3">
                <div>
                ...
                <div>
                  ...
                  <div className="mt-2 font-mono text-3xl font-semibold text-white tabular-nums">{contributions.length}</div>
                </div>
              </div>
      ...
      <div className="border-t border-white/[0.06] pt-6 text-sm leading-relaxed text-textdim">
        <strong className="font-semibold text-white">Reading these charts:</strong> each bar is one feature's contribution to
